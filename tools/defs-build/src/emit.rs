...
use crate::model::{
    ...
    MAX_FOOTPRINT_CELLS, RawAdjacencyRelation, RawCoherenceMode, RawDirection, RuleKindDef,
    SpriteRect,
};
...
pub fn emit_json(defs: &Defs, defs_version: &str) -> String {
    ...
    for (i, o) in defs.objects.iter().enumerate() {
        ...
        out.push_str(&format!(
            "    {{ \"collider\": {}, \"height\": {}, \"id\": {}, \"interact_at\": {}, \"key\": {}, \"layer\": {}, \"name\": {}, \"sprite\": {}, \"tags\": {}, \"width\": {}, \"window\": {} }}{comma}\n",
