...
use crate::model::{COLLIDER_SUBCELLS_PER_CELL, ColliderRect, Defs, INTERACT_AT_MAX_REACH_CELLS};
...
pub fn emit_rust(defs: &Defs, defs_version: &str) -> String {
    ...
    for o in &defs.objects {
        out.push_str(&format!(
            "    ObjectDef {{ id: {}, key: {:?}, width: {}, height: {}, collider: {}, interact_at: {}, window: {} }},\n",
            o.id,
            o.key,
            o.width,
            o.height,
...
pub fn emit_json(defs: &Defs, defs_version: &str) -> String {
    ...
    for (i, o) in defs.objects.iter().enumerate() {
        ...
        out.push_str(&format!(
            "    {{ \"collider\": {}, \"height\": {}, \"id\": {}, \"interact_at\": {}, \"key\": {}, \"width\": {}, \"window\": {} }}{comma}\n",
...
mod tests {
    ...
    fn emit_rust_opens_with_the_generated_header_and_carries_the_version() {
        ...
        assert!(out.contains(
            "ObjectDef { id: 1, key: \"trash_bin\", width: 1, height: 1, collider: Some(ColliderRect { x0: 4, y0: 4, x1: 12, y1: 12 }), interact_at: Some(ColliderRect { x0: 0, y0: 16, x1: 16, y1: 32 }), window: false }"
        ));
