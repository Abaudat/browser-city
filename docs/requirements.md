...
- **FR2** — The in-city clock is detached from real-world time: in-city midnight is aligned to no real boundary, so the in-city hour a player arrives at is set by the real minute within the hour, and ordinary sessions at varying times cover every in-city hour
