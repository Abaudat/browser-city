...
```bash
bash agentic-team/scripts/bc-comment.sh request-task <pr> tim <bodyfile>
```

That opens **one** comment of yours on the PR, marked `<!-- bc:taskreq:tim -->`, and wakes Scotty. His ruling lands on that same comment of yours.
