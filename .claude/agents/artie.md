...
```bash
bash agentic-team/scripts/bc-comment.sh request-task <pr> artie <bodyfile>
```

That opens **one** comment of yours on the PR, marked `<!-- bc:taskreq:artie -->`, and wakes Scotty. His ruling lands on that same comment of yours.
